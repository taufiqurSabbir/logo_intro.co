...
{{--</head>--}}
{{--<body>--}}
{{--<a href="{{url('/email/verify/'.$details['email'].'/'.$details['token'])}}">Click to confirm</a>--}}
{{--<p>{{url('/email/verify/'.$details['email'].'/'.$details['token'])}}</p>--}}
{{--</body>--}}
{{--</html>--}}
...
{{--                                                                                        </td>--}}
                                                                                    ...
                                                                                    <tr>
{{--                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">--}}
{{--                                                                                            <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="3%"  alt="" data-proportionally-constrained="true" data-responsive="false" src="public/frontend/img/mail.png" height="3%">--}}
{{--                                                                                        </td>--}}
                                                                                    </tr>
                                                                                    </tbody>
